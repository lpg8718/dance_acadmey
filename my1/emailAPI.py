def sendMail(email,password,subject="",html="",purpose_url=""):
	...
	if subject=="":
		msg['Subject'] = "verification for registration"
	else:
		msg['Subject'] = subject
	...
	if html=="":
		html = """<html>
  					<head></head>
  					<body>
    					<h1>Welcome to online Dance School</h1>
	...
	s.starttls() 
	s.login("lpg8718068669@gmail.com", "ejpevwjotmueyoao") 
